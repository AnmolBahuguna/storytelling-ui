...
// Exported as StarsBackground so you can use the same import name if you swap them out!
export { StarLayer, StarsBackgroundWhite as StarsBackground };
